...
- **The plugin market was re-pinned.** The bundled dshmarket dependency moved from 1.48.0 to 1.65.1: the old build crashes against the rewritten client (React error 130, caught by its own recovery panel), while 1.65.1 is self-contained and renders the full market UI.
