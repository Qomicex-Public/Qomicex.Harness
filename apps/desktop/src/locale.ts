...
export const en = {
  ...
  startupFailed: 'Qomicex Harness could not start',
  startupLoading: 'Starting Qomicex Harness…',
  ...
  updateTitle: 'Qomicex Harness Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Qomicex Harness {version}\n\nThis release includes its matching runtime version. The application will restart after installation.',
  installAndRestart: 'Install and Restart',
  later: 'Later',
  updateFailedTitle: 'Update Failed',
  pluginManagerTitle: 'Desktop Plugins',
  pluginWindowTitle: 'Qomicex Harness — Desktop Plugins',
...
export const zh = {
  application: '应用',
  startupFailed: 'Qomicex Harness 无法启动',
  startupLoading: '正在启动 Qomicex Harness…',
  ...
  updateTitle: 'Qomicex Harness 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'Qomicex Harness {version}\n\n新版本绑定匹配的运行时，安装后将重新启动。',
  installAndRestart: '安装并重启',
  later: '稍后',
  updateFailedTitle: '更新失败',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: 'Qomicex Harness — 桌面插件',
