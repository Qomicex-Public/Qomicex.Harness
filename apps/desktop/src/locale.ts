...
export const en = {
  ...
  aboutMenu: 'About Qomicex Harness',
  aboutProduct: 'Qomicex Harness',
  aboutVersion: 'Version V{version}',
  hideApplication: 'Hide Qomicex Harness',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit Qomicex Harness',
  edit: 'Edit',
  ...
  startupFailed: 'Qomicex Harness is unavailable',
  ...
  welcomeTitle: 'Qomicex Harness',
  welcomeBrand: 'Qomicex Harness',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'Qomicex Harness',
  welcomeTaglineAfter: '',
  ...
  updateDownloadedTitle: 'Qomicex Harness v{version} downloaded',
  ...
  updateDetail: 'Qomicex Harness {version}\n\nQomicex Harness will restart to complete the update.',
...
export const zh = {
  application: '应用',
  aboutMenu: '关于 Qomicex Harness',
  aboutProduct: 'Qomicex Harness',
  aboutVersion: '版本 V{version}',
  hideApplication: '隐藏 Qomicex Harness',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 Qomicex Harness',
  edit: '编辑',
  menuBar: '应用菜单',
  delete: '删除',
  undo: '撤销',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Qomicex Harness 无法使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Qomicex Harness v{version} 下载完成',
