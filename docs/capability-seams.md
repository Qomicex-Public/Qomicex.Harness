...
| `ctx.computerUse` | `seam` | [`computer-use`](../packages/computer-use/computer-use) | [`experimental-computer-use-cua-driver-mcp`](../packages/computer-use/cua-driver-mcp), [`experimental-computer-use-cua-driver-native`](../packages/computer-use/cua-driver-native) | [`experimental-computer-use-cua-driver-mcp`](../packages/computer-use/cua-driver-mcp), [`experimental-computer-use-cua-driver-native`](../packages/computer-use/cua-driver-native) | - | One provider-owned name per service instance. Each provider also owns its model tools; the service has no common action API, runtime selection, or Session workflow lock. |
