...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:291',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:285',
  },
  {
  ...
  },
  {
    ...
    declaredBy: 'factory \'conversation.content\' (client-ui-conversation), so it exists while that definition is registered',
    occupants: [
      'ui-brand-qomicex QomicexHeroMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-automation row.component',
      ...
      'client-ui-settings-web WebProviderRow',
  ...
  },
  {
    ...
    occupants: [
      ...
      'ui-brand-qomicex QomicexBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'ui-brand-qomicex QomicexBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
