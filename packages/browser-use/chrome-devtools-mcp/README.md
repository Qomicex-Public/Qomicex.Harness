...
- name: '@deepseek-ai/dsh-browser-use-chrome-devtools-mcp'
  config:
    mode: launch
    headless: true
```
...
The [configuration catalog](../../../docs/config-catalog.md#deepseek-aidsh-browser-use-chrome-devtools-mcp) lists accepted fields. The profile or preset selects the browser mode.
