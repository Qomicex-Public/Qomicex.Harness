...
- [Playwright MCP provider](../playwright-mcp/README.md) — Playwright browser tools.
- [Chrome DevTools MCP provider](../chrome-devtools-mcp/README.md) — Chromium inspection and control.
- [Stagehand provider](../stagehand-native/README.md) — native browser operations with AI assistance.
