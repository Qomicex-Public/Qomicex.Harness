...
- **Session deletion lives in Settings, behind an irreversibility confirmation** — the sidebar archives but never erases; the archived-sessions Settings page ([ui-settings-unarchive-sessions](../ui-settings-unarchive-sessions/README.md)) owns viewing, restoring, and permanently deleting them, and Workspace registration deletion does not delete Sessions.
