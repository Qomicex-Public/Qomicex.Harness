...
export const en = {
  ...
  modelFilter: 'Search models',
  modelFilterPlaceholder: 'Search models',
  modelAdd: 'Model ID',
  modelAddPlaceholder: 'Model ID, e.g. my-model-v2',
  addCustomModel: 'Add custom model',
  modelEfforts: 'Reasoning effort',
  modelEffortsHint: 'The levels this model offers; the default level is what a new session preselects.',
  modelEffortsInherited: 'Not customized: the installed catalog decides again.',
  modelEffortsDisableHint: 'No level selected: the model cannot reason, and the effort selector hides it.',
  effortInherit: 'Inherit',
  effortDefault: 'Default effort level',
  effortDefaultInherited: 'The provider default is preselected.',
  modelEffortWire: 'Value sent',
  modelEffortWirePlaceholder: 'Sends the level name',
  modelEffortWireRequired: 'Enter the value to send for each enabled level above Off.',
  modelEffortDefaultInvalid: 'The default effort level must be a level name.',
  effortOff: 'Off',
  ...
  fetchSearch: 'Search available models',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdd: '模型 ID',
  modelAddPlaceholder: '输入模型 ID，如 my-model-v2',
  addCustomModel: '添加自定义模型',
  modelEfforts: '推理强度',
  modelEffortsHint: '该模型支持的强度档位；默认思考等级决定新会话的预选档位。',
  modelEffortsInherited: '未自定义强度：沿用已安装的模型目录。',
  modelEffortsDisableHint: '未勾选任何档位：该模型不能推理，强度选择器将不再显示它。',
  effortInherit: '继承',
  effortDefault: '默认思考等级',
  effortDefaultInherited: '默认档位沿用提供商默认。',
  modelEffortWire: '发送值',
  modelEffortWirePlaceholder: '发送档位名',
  modelEffortWireRequired: '除 Off 外，每个勾选的档位都要填写发送值。',
  modelEffortDefaultInvalid: '默认思考等级必须是档位名。',
  effortOff: '关闭',
  effortMinimal: '极低',
  effortLow: '低',
  effortMedium: '中',
