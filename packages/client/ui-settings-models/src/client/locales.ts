...
export const en = {
  ...
  modelEffortsHint: 'Levels this model offers; each enabled level sends the value beside it. Untouched inherits the installed catalog.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelInputImage: '图片',
  modelEfforts: '推理强度',
  modelEffortsHint: '该模型提供的强度档位；勾选的每一档发送其旁边填写的值。保持不动则继承已安装的模型目录。',
