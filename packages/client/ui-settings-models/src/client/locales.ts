...
export const en = {
  ...
  modelEffortsHint: 'The level this model offers; it sends the level name. Click the selected level again to inherit the installed catalog.',
  modelEffortsInherited: 'Inherited from the installed catalog',
  modelEffortsDisable: 'Disable reasoning',
  modelEffortsDisableHint: 'The model cannot reason, and the effort selector hides it.',
  effortDefault: 'Reasoning effort',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelEfforts: '推理强度',
  modelEffortsHint: '该模型提供的强度档位，发送档位名；再次点击已选档位则恢复继承已安装目录。',
  modelEffortsInherited: '继承已安装的模型目录',
  modelEffortsDisable: '禁用推理',
  modelEffortsDisableHint: '该模型不能推理，强度选择器将不再显示它。',
